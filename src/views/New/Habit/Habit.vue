...
<script lang="ts">
 ...
 export default class Habit extends Vue{
  ...
  @Mutation
  private changeInspire!:(payload:{id:number;value:string}) => void;
  @Mutation 
 ...
 private get nameComputed(){
    ...
    console.log(habit,this.index,'habit index')
 ...
 private set inspireComputed(name){
    this.changeInspire({id:this.id, value:name})
 }
